...
case class MongoZioDatabase(private val javaMongoDatabase: JavaMongoDatabase) {
  ...
  /**
    * Executes command in the context of the current database.
    */
  def runCommand[TResult](clientSession: ClientSession, command: Bson, readPreference: ReadPreference)(using
      ct: ClassTag[TResult]
  ): Task[TResult] =
  ...
  /**
    ...
    */
  def listCollections[TResult]()(using ct: ClassTag[TResult]) =
  ...
  def listCollectionNames(clientSession: ClientSession): Task[String] =
    javaMongoDatabase.listCollectionNames(clientSession).toZIO

  /**
    * Finds all the collections in this database.
    */
  def listCollections[TResult](clientSession: ClientSession)(using ct: ClassTag[TResult]) =
